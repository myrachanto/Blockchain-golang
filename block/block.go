...
func (bc *Blockchain) SetNeighbors() {
	bc.neighbors = utils.FindNeighbors(utils.Gethost(), bc.port, NEIGHBOR_IP_RANGE_START, NEIGHBOR_IP_RANGE_START, BLOCKCHAIN_PORT_RANGE_START, BLOCKCHAIN_PORT_RANGE_END)
...
func (bc *Blockchain) StartMining() {
	bc.Mining()
	_ = time.AfterFunc(time.Second*MINNING_TIME_SEC, bc.StartMining)
}
